{preloader}
<div id="introduction" style="background: white; display:none;">
    <p> {introduction} </p>
</div>

<div id="selector" style="background: transparent; margin-top: 24px;">
    {content}
    <div id="selects" class="row" style="margin: 1px;">
        <div class="cell medium-3" style=""> <select id="year" data-placeholder="Year">
                <option>Year</option>
...
<hr style="margin: 16px 10%; width: 80%" />

<div id="bulb_result" style="background: white; display:none;margin-top: 24px;">
    <h1> {year_make_model} Bulb Size & LED Replacement Bulbs </h1>
...
<div id="videos" style="background: white; display:none; margin-top: 24px;">
    <h1> Installation Guide </h1>
    <p> Boslla LED products are highly recommand by a lot of Automotive YouTubers, such as <strong>Scotty Kimmer</strong>, <strong>JBLtv</strong>, <strong>Jhampa66</strong>, etc for the easy plug & play installation and well performance. We've got the highest views (over 4.5 million) in the LED headlight bulbs-related videos. Check the videos of {year_make_model} LED bulb installation guide below.</p>
    <p> {videos}</p>
</div>

<hr style="margin: 16px 10%; width: 80%" />

<div id="reviews" style="background: white; display:none; margin-top: 24px; visibility: hidden;">
    <h1> What Our Customers Say</h1>
    <p> We put customer experience and satisfaction as our priority, and we pride ourselves in providing the highest quality products and services standards for our customers. </p>
    <p> {reviews} </p>
</div>
